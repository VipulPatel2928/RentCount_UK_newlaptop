...
public class RentCount_CustomReporterBuildSummary extends RentCount_CustomReporterListener {
	...
	public RentCount_CustomReporterBuildSummary() {
		super();
...
//				+ skipped + "<br/></h3></td>");
		...
		m_out.println(
				"<table width='450px' height='200px' border='5' align='left'><tbody><tr colspan='2'><td bgcolor='#0088cc' colspan='2'><h1><center><font color='white'>Build Summary</font></center></h1></td></tr><tr bgcolor='#b1edc0'><td><b>"
				+ "<a href='CustomReporterTestPassedDetails.html' target='iframepass' >Passed Test cases</a></b>   </td> <td> <center><b>"
						+ passed + "</b></center></td></tr>"
								+ "<tr><td><b><a href='CustomReporterTestFailureDetails.html' target='iframepass'>Failed Test Cases</a></b></td><td> <center><b>" + (failedcount)
		...
		m_out.println("<div><iframe name='iframepass' src='CustomReporterTestPassedDetails.html' align='top' height='1000px' width='73%' hspace='10' vspace='10'></div>");
		m_out.println("</center>");
	}
...
//	}
	...
	private void startResultSummaryTable(String style) {  //5.2.1
		...
		m_out.println("<tr><td bgcolor='white' colspan='4'> <table border='0' width='100%' bgcolor='#e6f7ff'><tr>"
				...
				+ "<center><img width='250px' src='https://infovinity.com/wp-content/uploads/2017/11/hight_res_transparent_logo.png\n" + 
				"'/></center>"
				+ "</td><td ><center><font color='#008bcc'><b><h1>Automation Test Cases Analysis</h1></b></font></center></td> "
				+ "<td width='25%' bgcolor='white'>"
				+ "<center><img width='300px' src='https://www.3dbroadcastsales.com/pub/media/logo/default/3D_Broadcast_Ltd_Final_Logo_1_300.png'/></center></td> "
				+ "</tr></table> </td></tr>");
