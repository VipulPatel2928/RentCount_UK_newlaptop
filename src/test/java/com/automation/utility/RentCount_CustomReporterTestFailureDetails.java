...
public class RentCount_CustomReporterTestFailureDetails extends RentCount_CustomReporterListener {
	...
	public RentCount_CustomReporterTestFailureDetails() {
		super();
...
//	}
	...
	private void startResultSummaryTable(String style) {  //5.2.1
		...
		m_out.println("<table border='5' width='100%' bgcolor='#e6f7ff'>");
